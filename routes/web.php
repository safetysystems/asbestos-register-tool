...
Route::inertia('/asbestos-audits/create', 'AsbestosAudits/AsbestosForm')->name('asbestosaudits.asbestosform');
Route::inertia('/asbestos-audits/edit', 'AsbestosAudits/AsbestosForm')->name('asbestosaudits.asbestosform');